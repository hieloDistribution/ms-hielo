...
import com.sales.sync.auth.admin.AdminRoleGateFilter;
...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http,
                                    ...
                                    com.sales.sync.auth.admin.AdminRoleGateFilter adminRoleGateFilter) throws Exception {
        http
                .csrf(c -> c.disable())
                ...
                .authorizeHttpRequests(a -> a
                        ...
                        .requestMatchers("/api/v1/auth/admin/invites/redeem").permitAll()
                        .requestMatchers("/ws/**").permitAll()
                        .requestMatchers("/actuator/health", "/actuator/health/**", "/actuator/info").permitAll()
                        .anyRequest().authenticated())
                .addFilterBefore(jwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class)
                .addFilterAfter(adminRoleGateFilter, JwtAuthenticationFilter.class)
    ...
    @Bean
    com.sales.sync.auth.admin.AdminRoleGateFilter adminRoleGateFilter(
            com.sales.sync.auth.security.JwtService jwtService,
            com.sales.sync.auth.admin.RoleRequeryService roleRequery,
            com.fasterxml.jackson.databind.ObjectMapper objectMapper) {
        return new com.sales.sync.auth.admin.AdminRoleGateFilter(
                jwtService, roleRequery, objectMapper);
    }
