...
public class AdminController {
    ...
    @PostMapping("/invites")
    public AdminInviteResponse issueInvite(@RequestBody @Valid AdminInviteRequest body) {
        AdminService.IssuedInvite issued = adminService.issueInvite(
                authContext.requireUserId(), body.email(), body.role());
        return new AdminInviteResponse(issued.inviteId(), issued.token(), issued.expiresAt());
    }
